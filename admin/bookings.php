...
$where = []; $params = [];
if (in_array($filterStatus, $allowed)) { $where[] = 'b.status=?'; $params[] = $filterStatus; }
if ($filterClientId > 0) { $where[] = 'b.client_id=?'; $params[] = $filterClientId; }
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-3">
                    <?php
                    $fields = [['Client','vClient'],['Email','vEmail'],['Package','vPackage'],['Booking Date','vDate'],
                               ['Event Type','vEventType'],['Venue','vVenue'],['Status','vStatus'],['Booked On','vCreated']];
